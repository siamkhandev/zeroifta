                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-4">
                                    <div class="t-comp comm-counts">
                                        <div class="dc_inn">
                                            <div>
                                                <img src="{{asset('assets_new/img/company.png')}}" alt="ZeroIfta Image" />
                                            </div>
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-4">
                                    <div class="t-subs comm-counts">
                                        <div class="dc_inn">
                                            <div>
                                                <img src="{{asset('assets_new/img/subscription.png')}}" alt="ZeroIfta Image" />
                                            </div>
                                            @if(Auth::user()->role=="admin")
                                            <div class="count-content">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-4">
                                    <div class="t-paym comm-counts">
                                        <div class="dc_inn">
                                            <div>
                                                <img src="{{asset('assets_new/img/payment.png')}}" alt="ZeroIfta Image" />
                                            </div>
                                            @if(Auth::user()->role=="admin")
                                            <div class="count-content">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-4">
                                    <div class="t-form comm-counts">
                                        <div class="dc_inn">
                                            <div>
                                                <img src="{{asset('assets_new/img/contact.png')}}" alt="ZeroIfta Image" />
                                            </div>
                                            @if(Auth::user()->role=="admin")
                                            <div class="count-content">
                        ...
                        <div class="dashbord-inner">
                            ...
                            <div class="chart-area mb-4">
                                <div class="sec1-style">
                                    ...
                                    <div>
                                        <img class="w-100" src="{{asset('assets_new/img/chart.png')}}" alt="test" />
                                    </div>
                                </div>
                            </div>
                            <!-- Section 2 -->
