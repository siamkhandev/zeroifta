                                    ...
                                    <div class="row pt-3">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-2">
                                            <div class="dash-input mb-3">
                                                ...
                                                <input type="text" class="form-control login-input" id="exampleFormControlInput1" name="name" placeholder="{{__('messages.State Name')}}" value="{{old('name')}}" required/>
                                            </div>
                                            @error('name')
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 mb-2">
                                            <div class="dash-input mb-3">
                                                ...
                                                <input type="text" class="form-control login-input" id="exampleFormControlInput1" name="code" placeholder="{{__('messages.State Code')}}"  value="{{old('code')}}" required/>
                                            </div>
                                            @error('code')
                                                <span class="invalid-feedback" role="alert" style="display: block;">
                                                    <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 mb-2">
                                            <div class="dash-input mb-1">
                                                ...
                                                <input type="number" min="0" class="form-control login-input dis-input" id="exampleFormControlInput1" required name="tax" placeholder="{{__('messages.Tax')}}" max="100" value="{{old('tax')}}" />
                                            </div>
                                            @error('tax')
                                                <span class="invalid-feedback" role="alert" style="display: block;">
                                                    <strong>{{ $message }}</strong>
