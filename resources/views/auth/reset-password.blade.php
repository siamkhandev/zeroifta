            ...
            <div class="authRight_inn">
              ...
              <form method="POST" action="{{ route('password.updatepas') }}">
                ...
                <div class="log_input mb-3 pass-input">
                    ...
                    <!-- Password Icon -->
                    <div class="show-pass" onclick="togglePasswordVisibility('password', 'show-icon1', 'hide-icon1')">
                ...
                <div class="log_input mb-3 pass-input">
                    ...
                    <!-- Password Icon -->
                    <div class="show-pass" onclick="togglePasswordVisibility('password_confirmation', 'show-icon2', 'hide-icon2')">
