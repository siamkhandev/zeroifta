            ...
            <div class="row pt-3">
                <div class="col-lg-6 col-md-6 col-sm-12 col-12 mb-2">
                    <div class="dash-input mb-3">
                        ...
                        <input type="text" class="form-control login-input" id="exampleFormControlInput1" placeholder="Vehicle Type" name="vehicle_type" value="{{old('vehicle_type')}}"/>
                    </div>
                    @error('vehicle_type')
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-12 mb-2">
                    <div class="dash-input mb-3">
                        ...
                        <input type="text" class="form-control login-input" id="exampleFormControlInput1" placeholder="Add Vehicle Number" name="vehicle_number" value="{{old('vehicle_number')}}" />
                    </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-12 mb-2">
                    <div class="dash-input mb-3">
                        ...
                        <input type="text" class="form-control login-input" id="exampleFormControlInput1" placeholder="Add Odometer Reading" name="odometer_reading" value="{{old('odometer_reading')}}" />
                    </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-12 mb-2">
                    <div class="dash-input mb-3">
                        ...
                        <input type="text" class="form-control login-input" id="exampleFormControlInput1" placeholder="Add MPG" name="mpg" value="{{old('mpg')}}" />
                    </div>
                    @error('mpg')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-12 mb-2">
                    <div class="dash-input mb-3">
                        ...
                        <input type="text" class="form-control login-input" id="exampleFormControlInput1" placeholder="Add Fuel Tank Capacity" name="fuel_tank_capacity" value="{{old('fuel_tank_capacity')}}" />
                    </div>
