      ...
      <div class="sec1-style">
        <div class="tabele_filter">
          ...
          <div class="filter-btn">
            <a class="blueLine_btn" href="{{route('driver_vehicles.add')}}">{{__('messages.Assign Vehicle')}}+</a>
          </div>
        </div>
      </div>
    </div>
              ...
              <td class="table-text-left">
                <div class="tabAction-list">
                  ...
                  <span class="tabEdit-icon">
                    <a href="{{route('driver_vehicles.edit',$vehicle->id)}}">
                          ...
                          <div class="modal-body">
                            <div class="text-center">
                              ...
                              <div class="buttons pt-3">
                                ...
                                <a href="{{route('driver_vehicles.delete',$vehicle->id)}}" class="mainBtn">{{__('messages.Submit')}}</a>
                              </div>
                            </div>
                          </div>
                        </div>
