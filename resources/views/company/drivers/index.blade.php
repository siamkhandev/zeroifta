            ...
            <tr>
              ...
              <td>
                <div class="table-conTab">
                  <span>
                    @if($driver->driver->driver_image)
                    <img src="{{asset('drivers')}}/{{$driver->driver->driver_image}}" class="avatar avatar-sm me-3" alt="user1" style="height: 30px;">
                    @else
              ...
              <td>
                <div class="tabAction-list">
                  ...
                  <span class="tabDel-icon">
                    ...
                    <span class="hover" href="#" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal-{{$driver->driver->id}}">
                  ...
                  <div class="delete_modal modal-comm">
                    <!-- Modal -->
                    <div class="modal fade" id="exampleModal-{{$driver->driver->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
