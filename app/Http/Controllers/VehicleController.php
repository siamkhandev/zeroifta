...
class VehicleController extends Controller
{
    ...
    public function allVehicles(Request $request)
    {
        ...
        $vehicles = Vehicle::whereIn('id', $driverVehicles->pluck('vehicle_id'))->select('id','vehicle_image','vehicle_number','mpg','odometer_reading','fuel_left','fuel_tank_capacity','model','make','year','license_plate_number')->get();
        if(count($vehicles) >0){
